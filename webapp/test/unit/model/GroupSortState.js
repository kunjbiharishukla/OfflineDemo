sap.ui.define([
	"com/sap/offlinedemo/OfflineDemo/model/GroupSortState",
	...
	QUnit.test("Should set the grouping to None if the user sorts by SupplierId and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("SupplierId");
