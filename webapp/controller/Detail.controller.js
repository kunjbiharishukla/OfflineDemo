/*global location */
sap.ui.define([
	"com/sap/offlinedemo/OfflineDemo/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"com/sap/offlinedemo/OfflineDemo/model/formatter",
	"sap/m/MessageBox",
	"sap/m/MessageToast"
], function (BaseController, JSONModel, formatter, MessageBox, MessageToast) {
	"use strict";

	return BaseController.extend("com.sap.offlinedemo.OfflineDemo.controller.Detail", {
		...
		onDelete: function () {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/SupplierId"),
